...
class ExcelController extends CommonController
{
	...
	function import(){
		...
		if(!is_dir(APP_PATH.'Public/Admin')){
			mkdir(APP_PATH.'Public/Admin',0777);
		}
		...
		if($excel_molds=='newmolds'){
			...
			$this->field_exits = ['id','tid','userid','orders','member_id','comment_num','htmlurl','isshow','tags'];
	...
	function importover(){
		...
		if($molds!='newmolds'){
			...
			//创建新模块字段
			$field_exits = ['id','tid','userid','orders','member_id','comment_num','htmlurl','isshow','tags'];
