    ...
    <div class="user-right">
      <div class="user-tips">
        ...
        <form method="POST" onsubmit="return checklogin()" class="user-form">
		  ...
		  <?php if($webconf['closehomevercode']!=1){ ?>
          <div class="form-control">
            <label for="">验证码：</label>
            <input type="text" value="" name="vercode" id="yzm" placeholder="请输入验证码">
            <img src="<?php echo U('common/vercode',['code_name'=>'login_vercode','r'=>rand(111,999)]) ?>" onclick="this.src=this.src+'?'+Math.random()" style="height:50px;"/>
          </div>
		  <?php } ?>
